 ...
 */
var foodEatenForContract = 0;
Snake = function(game, spriteKey, x, y, foodEatenForContract) {
    this.game = game;
...
Snake.prototype = {
    ...
    updateFoodEatenDisplay: function() {
        document.getElementById("foodEatenDisplay").innerHTML = "Food Eaten: " + this.foodEaten;
    },

    updateFoodEaten: function(){
        this.foodEaten++;
        this.updateFoodEatenDisplay();
    },
    /**
     * Destroy the snake
     */
